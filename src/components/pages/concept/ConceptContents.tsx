    ...
    return (<div className="contents">
        ...
        <div className="conceptContainer__databody databody">
            ...
            <p>ロシア・アヴァンギャルドを代表する芸術家、グラフィックデザイナーである<br />
                <a href="https://ja.wikipedia.org/wiki/%E3%82%A8%E3%83%AB%E3%83%BB%E3%83%AA%E3%82%B7%E3%83%84%E3%82%AD%E3%83%BC" target="_blank">エル・リシツキー（El Lissitzky ）</a>のシュプレマティックな作品群から着想を得てデザインされました。<br />
                <br />
                サイト内の統一的な赤とグレーと背景の白は、彼がよく使用した赤、黒、白の配置をもとに構成しました。<br />
                <br />
                参考：
                <ul>
                    <li><a href="https://www.kodomo.go.jp/gallery/modernism/09_for2/index.html" target="_blank">二つの正方形について</a></li>
                    <li><a href="https://bunka.nii.ac.jp/heritages/detail/112187" target="_blank">赤き楔で白を撃て</a></li>
                </ul>
                <br />
